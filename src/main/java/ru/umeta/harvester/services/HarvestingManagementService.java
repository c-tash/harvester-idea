...
import ru.umeta.harvesterspring.db.*;
...
public class HarvestingManagementService implements IHarvestingManagementService {
	...
	final static String[] msgArr = {"dd"};//ErrorMessagesXMLParser.main("ErrorMessages.xml",ErrorMessagesXMLParser.RU);
...
//	}
	...
	/* (non-Javadoc)
	 * @see ru.umeta.harvesterspring.services.IHarvestingManagementService#addQuery(java.lang.String, java.lang.String, ru.umeta.harvesting.base.model.Query)
	 */
	@Override
	...
	public QueryMessage getQueriesForUser(String login, String pw) {
		...
		if (!DBSelectUser.dbConnect(login)) {
			msg.code = 2;
			msg.text = noXMLflag ? "Providing error message has failed. ������ ��� ������� ��������� ������." : msgArr[msg.code];
			return msg;
		} else
			if (DBCheckPass.dbConnect(login, pw, uid)) {
	...
	/* (non-Javadoc)
	 * @see ru.umeta.harvesterspring.services.IHarvestingManagementService#register(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ru.umeta.harvesterspring.services.IHarvestingManagementService#deleteQuery(java.lang.String, java.lang.String, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ru.umeta.harvesterspring.services.IHarvestingManagementService#activateQuery(java.lang.String, java.lang.String, int)
	 */
	@Override
